...
CREATE TABLE `USER_DEVICE_INFO` (
  ...
  `RESOLUTION1` varchar(50) DEFAULT NULL,
  `MONITOR2` varchar(100) DEFAULT NULL,
  `RESOLUTION2` varchar(50) DEFAULT NULL,
  `DATE` int NOT NULL,
  `FLAG` int NOT NULL,
  `MAC_ADDR1` varchar(100) DEFAULT NULL,
  `MAC_ADDR2` varchar(100) DEFAULT NULL,
...
CREATE TABLE `USER_INFO` (
  ...
  `BK_START` int DEFAULT NULL,
  `BK_END` int DEFAULT NULL,
  `ROOTSIZE` int DEFAULT NULL,
  PRIMARY KEY (`SEQ`)
...
-- Dump completed on 2022-06-06 20:00:01
