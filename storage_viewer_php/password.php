...
<body>
  <form name="login_form" action="password_ok.php" method="post" onsubmit="return login_check()">
    <fieldset>
      <legend>패스워드 수정</legend>
      <p>
        <label for="USERID" class="txt">아이디</label>
        <input type="text" name="USERID" id="USERID" class="USERID" autofocus placeholder="아이디">
        <br>
      ...
      <p>
        <label for="PASSWORD2" class="txt">비밀번호 확인</label>
