...
EXCLUDE4="--exclude=/opt/aspera/* --exclude=/opt/ktftp2/*  --exclude=/pm/* --exclude=/super/* --exclude=/previz/* --exclude=/Matte/*"

EXCLUDE5="--exclude=/env/* --exclude=/fxdata/* --exclude=/fxcache/* --exclude=/katana/* --exclude=/gpfs_backup/* --exclude=/home/$EMPNO/.local/share/Trash/* --exclude=/var/tmp/* --exclude=/testdata/*"
